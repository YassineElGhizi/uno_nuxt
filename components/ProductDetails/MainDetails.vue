          ...
          <div class="row">
            <div class="col-sm-4 flex-column">
              <div class="ul-product-detail__image" >
                <img src="https://static5.depositphotos.com/1034256/424/i/600/depositphotos_4246298-stock-photo-looking-at-africa.jpg"
                  alt="">
              </div>
              ...
              <div class="ul-product-detail__brand-name">
                <div class="row" >
                  <div class="col col-sm-7">
                    ...
                    <span class="text-mute text-14">{{ short_description }}</span>
                    ...
                    <div class="ul-product-detail__features">
                      <ul class="m-0 p-2">
                        ...
                        <li>
                          <div class="mb-3" >
                            <span class="text-mute font-weight-700 text-16 mb-2" v-if="options.length != 0" >Options :</span>
                          </div>
                          <div class="form-row">
                          ...
                          <span class="t-font-boldest ul-cursor--pointer mb-2 collapsed" data-toggle="collapse"
                                data-target="#collapse-text" aria-expanded="false">+ see all varaition</span>
                    ...
                    <div class="row mb-5">
                          ...
                          <div class="ul-widget-card__item p-0">
                                                        <span class="ul-widget-s6__badge ul-widget-card__dot">
                                                            <img class="profile-picture avatar-sm rounded-circle mb-2"
                                                                 src="http://127.0.0.1:9898/assets/images/Apple-logo.png"
                                                                 alt="">
                                                        </span>
                      ...
                      <div class="col-6">
                        <div class="d-flex justify-content-end">
                          <ul class="nav">
                            <li class="nav-item">
                              <a class="btn btn-lg active show"><i class="far fa-heart" id="heart-icone"
                                                                   style="font-size: 20px;"></i></a>
                            </li>
                            <li class="nav-item">
                              <a class="btn btn-lg"><i class="far fa-bell" id="bell-icone"
                                                       style="font-size: 20px;"></i></a>
                            </li>
                          </ul>
                        </div>
                    ...
                    <div class="row justify-content-center">
                      <div class="col col-lg-9 col-md-9 col-sm-12">
                        <div class="ul-widget4__actions">
                          <p class="text-18 text-success text-600 align-top">Best Price</p>
                          ...
                          <button type="button" class="btn btn-outline-success btn-lg btn-block m-1"
                                  onclick="Product_best_store_id">
                            Go to Shop
                          </button>
...
export default {
  name: "MainDetails",
  props: ['product_name', 'brand_name', 'short_description', 'rating', 'best_price', 'options', ],
}
</script>
